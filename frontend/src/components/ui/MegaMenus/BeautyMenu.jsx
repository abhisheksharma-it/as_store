  ...
  return (
    <div className="grid grid-cols-4 gap-6 p-8">
      ...
      <div className="relative h-full min-h-[400px] overflow-hidden group">
        <img
          src="https://images.pexels.com/photos/4938508/pexels-photo-4938508.jpeg?auto=compress&cs=tinysrgb&h=900&w=600"
          alt="Beauty editorial"
          className="absolute inset-0 w-full h-full object-cover"
        />
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent" />
        <Link
          to="/products/beauty/new-in"
